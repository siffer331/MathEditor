...
subst1 = Rule
  { assumptions =
    ...
    , Membership [SubContextIn 1, OfTypeIn 2 (Generic 1), SubContextIn 0] (Generic 3) (Generic 4)
    ]
  , conclusion = Membership [SubContextReplace 1 (GenericOut 0) 2, SubContextOut 0]
...
pointVariableJudgement = apply vble [(1,0)] =<< sequence [pointVariableCtx]
